...
/**
 * @method Messages setMpid(int $id)
 * @method Messages setStatusDate(string $date)
 * @method Messages setStatus(array $status)
 * @method Messages setIdBatch(int $id)
 * @method Messages setDebtorNumber(string $number)
 * @method Messages setPaymentReference(string $reference)
 * @method Messages setRpp(int $rpp)
 * @method Messages setPage(int $page)
 * @method Messages setDetails(int $detail)
 * @method Messages setFirstname(string $name)
 * @method Messages setLastname(string $name)
 * @method Messages setEmailaddress(string $email)
 * @method Messages setMobilenumber(string $number)
 * @method Messages setAddressStreet(string $street)
 * @method Messages setAddressNumber(string $number)
 * @method Messages setAddressPostcode(string $postalcode)
 * @method Messages setAddressCity(string $city)
 * @method Messages setDebtornumber(string $debtornumber)
 * @method Messages setPaymentReference(string $reference)
 * @method Messages setConcerning(string $concerning)
 * @method Messages setIdBatch(string $id)
 * @method Messages setIdRequestClient(string $id)
 * @method Messages setCompanyName(string $name)
 * @method Messages setEmailTemplate(int $id)
 * @method Messages setSmsTemplate(int $id)
 * @method Messages setLetterTemplate(int $id)
 * @method Messages setReminderTemplate(int $id)
 * @method Messages setVariable1(string $variable)
 * @method Messages setVariable2(sttring $variable)
 * @method Messages setVariable3(string $variable)
 * @method Messages setVariable4(string $variable)
 * @method Messages setVariable5(string $variable)
 * @method Messages setUsername(string $username)
 * @method Messages setModuleIdeal(int $integer)
 * @method Messages setModuleMisterCash(int $integer)
 * @method Messages setModulePaypal(int $integer)
 * @method Messages setModuleSofort(int $integer)
 * @method Messages setModuleCreditcard(int $integer)
 * @method Messages setModulePaysafecard(int $integer)
 * @method Messages setModuleBanktransfer(int $integer)
 * @method Messages setModuleEmandate(int $integer)
 * @method Messages setModuleUbl(int $integer)
 * @method Messages setInvoices(array $invoices)
 * @method Messages setTerms(array $terms)
 */
